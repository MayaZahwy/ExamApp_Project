...
/**
 * Test Queries File
 * Demonstrates various database operations against the aligned schema.
 */
...
async function runTests() {
  try {
    ...
    console.log('\n4️⃣  Fetching One Exam with Questions...');
    ...
    console.log('\n6️⃣  Exam Submissions with User Information...');
